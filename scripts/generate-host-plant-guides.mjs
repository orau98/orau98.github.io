...
function renderIndexPage(guides) {
...
function main() {
  ...
  guides.forEach((guide) => {
    fs.writeFileSync(path.join(OUT_DIR, `${guide.slug}.html`), renderGuidePage(guide), 'utf-8');
  });
  fs.writeFileSync(path.join(OUT_DIR, 'index.html'), renderIndexPage(guides), 'utf-8');
