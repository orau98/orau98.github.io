...
export const HOST_PLANT_GUIDES = [
  ...
  },
  {
    slug: 'take-sasa',
    name: 'タケ・ササ',
    variants: ['タケ', 'ササ', 'マダケ', 'メダケ', 'モウソウチク', 'ハチク', 'ネザサ'],
...
const CATEGORY_GUIDES = [
  ...
  },
  {
    slug: 'oak-family',
    name: 'ブナ科・どんぐりの木',
    plantSlugs: ['kunugi', 'konara', 'kuri', 'buna', 'kashiwa', 'mizunara', 'arakashi', 'shirakashi', 'sudajii', 'abemaki', 'ubamegashi'],
    searchPhrases: ['どんぐりの木につく虫', 'ブナ科 幼虫 食草', 'クヌギ コナラにつく虫'],
  },
  {
    slug: 'weeds-and-grasses',
    name: '草本・雑草',
    plantSlugs: ['yomogi', 'susuki', 'irakusa', 'karamushi', 'itadori', 'shirotsumekusa', 'yoshi', 'ine', 'sumire', 'mizosoba', 'gishigishi', 'oobako'],
