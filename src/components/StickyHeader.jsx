        ...
        <div className="max-w-6xl mx-auto flex items-center gap-3 sm:gap-4">
          ...
          <div className="flex-1 max-w-2xl relative">
            ...
            <input
              ...
              className="block w-full pl-9 sm:pl-10 pr-3 py-2 border border-slate-300 dark:border-slate-600 rounded-full leading-5 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-500 focus:outline-none focus:bg-white dark:focus:bg-slate-900 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm transition-colors shadow-sm"
            />
          </div>
