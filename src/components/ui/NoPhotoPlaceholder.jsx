  ...
  bug: (
    <>
      <g fill="currentColor">
        ...
        <ellipse cx="12" cy="8.6" rx="3.1" ry="1.8" />
        <path d="M12 10.2c2.9 0 5 2.1 5 5 0 3.1-2.2 5.6-5 5.6s-5-2.5-5-5.6c0-2.9 2.1-5 5-5z" />
      </g>
      <g stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" fill="none">
        <path d="M11 4.3c-.7-1-1.6-1.6-2.7-1.8M13 4.3c.7-1 1.6-1.6 2.7-1.8" />
        <path d="M7.6 11 4.9 9.3M7 14.2l-3.2-.1M7.7 17.3 5 19.4" />
        <path d="M16.4 11l2.7-1.7M17 14.2l3.2-.1M16.3 17.3l2.7 2.1" />
      </g>
    </>
  ),
  // 芽生え（植物）
