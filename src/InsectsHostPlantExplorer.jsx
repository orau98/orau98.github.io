    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <div className="max-w-6xl mx-auto space-y-6 p-4 md:p-8">
        <div className="relative w-full h-64 md:h-80 lg:h-96 rounded-3xl overflow-hidden shadow-2xl group">
          ...
          <img 
            src={import.meta.env.DEV ? "/images/moths/Cucullia_argentea.jpg" : `${import.meta.env.BASE_URL}images/moths/Cucullia_argentea.jpg`} 
            ...
            onError={(e) => { 
              ...
              e.target.src=import.meta.env.DEV ? "/images/placeholder.jpg" : `${import.meta.env.BASE_URL}images/placeholder.jpg`; 
