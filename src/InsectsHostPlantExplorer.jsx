                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                      <div className="space-y-2.5">
                        <div>
                          <p className="font-medium text-xs mb-1 text-slate-700 dark:text-slate-300">はじめに</p>
                          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                            当サイトは、昆虫と植物の関係を、誰もが手軽に調べられるデータベースを目指して作成しています。掲載されている情報は、管理者が既存の図鑑や学術文献などを基にまとめたものです。
                          </p>
                        </div>
                        <div>
                          <p className="font-medium text-xs mb-1 text-slate-700 dark:text-slate-300">免責事項</p>
                          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                            データの正確性には細心の注意を払っておりますが、参照した文献が古かったり、解釈に誤りが含まれていたりする可能性があります。学術研究やその他重要な目的でデータを利用される場合は、必ずご自身で原典をご確認いただきますようお願いいたします。
                          </p>
                        </div>
                        <div>
                          <p className="font-medium text-xs mb-1 text-slate-700 dark:text-slate-300">写真について</p>
                          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                        ...
                        <div>
                          <p className="font-medium text-xs mb-1 text-slate-700 dark:text-slate-300">お問い合わせ</p>
                          <p className="text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
